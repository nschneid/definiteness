...
\begin{align*}
\hat{\boldsymbol{\theta}} = \arg \max_{\boldsymbol{\theta}}-{\lambda} ||\boldsymbol{\theta}||^2_2 + \sum_{\langle x,y \rangle\in\mathcal{D}} \log{\frac{\exp{\boldsymbol{\theta}^{\top}\mathbf{f}(x,y)}}{\sum_{y' \in \mathcal{Y}}\exp{\left(\boldsymbol{\theta}^{\top}\mathbf{f}(x,y')\costversion{ + \kappa\textit{cost}(y,y')}\right)}}} \\
\end{align*}
}
