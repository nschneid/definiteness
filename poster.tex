...
We use an in-house implementation of a multiclass logistic regression classifier with L2-regularization [***AB: Do we want to say why we used L2, & why log regression? Also how do I make the following equatoin look better? I don't want the first part to be in the center, but more to the left.*** ].
\begin{align*}
\hat{\boldsymbol{\theta}} = \arg \max_{\boldsymbol{\theta}}-{\lambda} ||\boldsymbol{\theta}||^2_2 + \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Scheme%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{The language independent scheme for Communicative Functions of Definiteness}{name=scheme,column=1.15,span = 1.85}{
...
\begin{tabular}{|l|c|c|}
      %\hline
 \multicolumn{1}{p{9em}}{Leaf label} & \multicolumn{1}{c}{N} & \multicolumn{1}{c}{F1}	\\				
       \hline %\hline
...
[***AB: will add all teh other labels a bit later.***]
}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Analysis%%%%%%%%%%%%%%%%%%%%    %%%%%%%%%%%%%%%%%%
 \headerbox{Analysis}{name=anal,column=3,span=1,below=results}{
 %\scriptsize 
\begin{description}
 \item [Confirmation of known facts] ...
 \item [Good hypotheses to test] ...
 \item [Baffling cases] ... 
\end{description}
