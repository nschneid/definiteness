...
We use an in-house implementation of a multiclass logistic regression classifier (logistic regression allows us to analyze the feature weights and hence generate hypotheses regarding form-function interactions). [***AB: will add or just replace with the weight times percept version of the objective once am sure about it***].
\begin{align*}
