...
{\bf Feature function:}\phantom{*********}\mathbf{f}(x,y) = \boldsymbol{\phi}(x) \times \tilde{\boldsymbol{\omega}}(y)\\


{\bf Feature weight vector:}\begin{align*}
...
+ proper nouns (NNP)& + NPs with possessive pronouns immediately preceding\\
+ 2nd person pronouns& \phantom{+ }the head (rather than the ones with intervening words)\\
+ NPs with "the" as the first dependent & \\\hline\\
- the indefinite article "a" & - NPS with comparative adjectives (JJR) \\\hline
\end{tabular}
 \end{left}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Acknowledgements%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\scriptsize 
\headerbox{Acknowledgements}{name=ack,column=0,span=1.89,below=anal}{
