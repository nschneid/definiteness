...
We use an in-house implementation of a multiclass logistic regression classifier [***AB: Do we want to say why we used log regression? something as follows:***] as the results are interpretable (logistic regression allows us to analyze the feature weights and hence generate hypotheses regarding form-function interactions). [***AB: will add or just replace with the weight times percept version of teh objective once am sure about it***].
\begin{align*}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Scheme%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Communicative Functions of Definiteness}{name=scheme,column=1.15,span = 1.85}{
...
\smaller[.5]
 \begin{tabular}{p{22em}p{3em}} 
   \\\hline{\bf Nonanaphora} [-A,-B]&${\bf 999}$\\\hline\\{\bf - Unique} [+U]&${\bf 287}$\\$*${\bf Unique\_Hearer\_Old} [+F,-G,+S]&${\bf 251}$\\Unique\_Physical\_Copresence [+R]&$13$\\Unique\_Larger\_Situation [+R]&$237$\\Unique\_Predicative\_Identity [+P]&$1$\\$*$Unique\_Hearer\_New [-F]&$36$\\\\{\bf - Nonunique} [-U]&${\bf 581}$\\$*${\bf Nonunique\_Hearer\_Old} [+F]&${\bf 169}$\\Nonunique\_Physical\_Copresence [-G,+R,+S]&$39$\\Nonunique\_Larger\_Situation [-G,+R,+S]&$117$\\Nonunique\_Predicative\_Identity [+P]&$13$\\$*$Nonunique\_Hearer\_New\_Spec [-F,-G,+R,+S]&$231$\\$*$Nonunique\_Nonspec [-G,-S]&$181$\\\\{\bf - Generic} [+G,-R]&${\bf 131}$\\$*$Generic\_Kind\_Level&$0$\\$*$Generic\_Individual\_Level&$131$ 
 \end{tabular} 
& 
\smaller[.5]
 \begin{tabular}{p{22em}p{3em}} 
   \\\hline{\bf Anaphora} [+A]&${\bf 1574}$\\\hline\\{\bf - Basic\_Anaphora} [-B,+F]& ${\bf 795}$\\$*$Same\_Head&$556$\\$*$Different\_Head&$329$\\\\{\bf - Extended\_Anaphora} [+B]&${\bf 779}$\\$*$Bridging\_Nominal [-G,+R,+S]&$43$\\$*$Bridging\_Event [+R,+S]&$10$\\$*$Bridging\_Restrictive\_Modifier [-G,+S]&$614$\\$*$Bridging\_Subtype\_Instance [-G]&$0$\\$*$Bridging\_Other\_Context [+F]&$112$\\\\\hline{\bf Miscellaneous} [-R]&${\bf 732}$\\\hline\\- Pleonastic [-B,-P]&$53$\\- Quantified&$248$\\- Predicative\_Equative\_Role [-B,+P]&$58$\\- Part\_Of\_Noncompositional\_MWE&$100$\\- Measure\_Nonreferential&$125$\\- Other\_Nonreferential&$148$
 \end{tabular} \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Examples%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Examples for Communicative Functions}{name=example,column=1.15,span = 1.85,below=scheme}{
...
\feat{Log}\\
+ \feat{attributes} & 473,064 & 38.7 & 77.1 \\ 
+ \feat{labels} & 413,931 & 40.8 & 73.6 \\ 
+ \feat{attributes, labels} & 926,417 & 43.7 & {\bf 78.2} \\
...
\end{center}
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Analysis%%%%%%%%%%%%%%%%%%%%    %%%%%%%%%%%%%%%%%%
 \headerbox{Analysis}{name=anal,column=3,span=1,below=results}{
 %\scriptsize 
\begin{center}\small
 \smaller [.5]
{\bf Confirmation of known facts: Specificity}
 \begin{tabular}{|l|l|}
  \multicolumn{1}{p{8em}}{High +ve wts} & \multicolumn{1}{l}{High -ve wt}    \\
        \hline %\hline
the definite article "the" & the indefinite article "a"\\possessives (PRP\$)\\proper nouns (NNP)\\2nd person pronouns\\NPs with "the" as the first dependent \\\hline
\end{tabular}
 \end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Acknowledgements%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Acknowledgements}{name=ack,column=3,span=1,below=anal}{
%\scriptsize 
