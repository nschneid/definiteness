...
\begin{tabular}{|l|r|c|c|}
      %\hline
 \multicolumn{1}{p{5em}}{Condition} &  \multicolumn{1}{c}{\# Params}	&  \multicolumn{1}{c}{ExactMatch(\%)} &  \multicolumn{1}{c}{SoftMatch(\%)}    	\\				
       \hline %\hline
...
\begin{center}\small
 \smaller [.5]
{\bf Confirmation of known facts: Specificity}
 \begin{tabular}{|l|l|}
...
\begin{center}\small
  \smaller [.5]
{\bf Good hypotheses to test: Specificity}
  \begin{tabular}{|l|l|}
   \multicolumn{1}{p{8em}}{High `+' weights} & \multicolumn{1}{l}{High `-' weights}    \\
         \hline %\hline
