...
%tracking noun phrase reference for 
...
\Citet[pp. 6--7]{croft-03}, for instance, shows that the conditions under which a noun phrase 
...
\multicolumn{1}{c}{\bf Condition} & \multicolumn{1}{c}{$|\boldsymbol{\theta}|$} & \multicolumn{1}{c}{$\lambda$} 
& \multicolumn{1}{c}{\bf Exact Match Accuracy} & \multicolumn{1}{c}{\bf Soft Match Accuracy} 
