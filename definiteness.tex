...
Throughout our experiment, we use the NP boundaries identified by the human annotators (gold NP boundaries).   Thus, for training as well as testing, we
extract percepts for gold NPs and assign labels to gold NPs.    We do not consider the other possible NPs identified by the parser.     However, we use the parser to find percepts, such as the lemma of the head of which the NP is a dependent or the part of speech of the first dependent of the NP.     If there is a conflict between the gold NP boundaries and the parsed NP boundaries, to avoid extracting wrong percepts, we assign a default value.  For example, some of our percepts are properties of the "outbound head", the immediate parent node to which the NP under consideration is attached.    
We assume the gold NP boundary and look for words within this boundary which have an outbound dependency (a link to a word outside the NP boundary).    If there is a conflict between the gold boundary  and the parser generated boundary or if multiple words with outbound dependencies are found, then
...
Full log-linear classifier (labels + attributes) & 926,417 & 100 & 43.7 & \bf 82.5 \\
Random forest classifier & 20,363 & \multicolumn{1}{c}{---} & \bf 49.7 & 81.0 \\
\end{tabular}
...
Pleonastic & 100 & 78 & 88 \\
Nonunique\_generic\_nonspec & 9 & 25 & 13 \\
Other\_Nonreferential & 39 & 36 & 37 \\
Nonunique\_Larger\_situation & 29 & 25 & 27 \\
Bridging\_OtherContext & 33 & 6 & 11 \\
Same\_head & 41 & 41 & 41 \\
Unique\_Hearer\_new & --- & --- & --- \\
Quantified & 57 & 57 & 57 \\
Different\_head & 32 & 33 & 32 \\
Bridging\_nominal & 33 & 10 & 15 \\
Measure\_Nonreferential & 88 & 26 & 40 \\
Part\_of\_noncompositionalMWE & 20 & 17 & 18 \\
Bridging\_restrictiveModifier & 58 & 84 & 68 \\
Nonunique\_Hearer\_new\_spec & 36 & 46 & 40 \\
Predicative\_Nonidentity & --- & --- & --- \\
Unique\_Larger\_situation & 52 & 58 & 55 \\
Generic\_individualLevel & 14 & 11 & 13 \\
Bridging\_event & --- & --- & --- \\
