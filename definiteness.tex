...
Whether a NP is realized grammatically as definite or not 
...
Sometimes definiteness is marked with affixes or clitics, as in Arabic; sometimes it is expressed through other constructions, e.g.  
\citet{chen04} shows that in Chinese (a language without articles), the existential construction is used to express indefinite subjects and the {\it ba}- construction for definite direct objects. 
