...
predict an NP's communicative function in terms of a language-universal classification scheme. Our classifiers establish strong baselines for future work in this neglected area of computational semantic analysis. In addition, analysis of the features and learned parameters 
...
for expressing aspects of meaning such as identifiability 
...
{\bf Basic\_Anaphora} applies to NPs for entities that have been mentioned before. 
...
The function {\bf Nonunique} applies to NPs \nss{that start out with?} multiple possible referents 
and that may or may not become identifiable in a speech situation. 
For example, {\em a little riding hood of red velvet} in \cref{fig:excerpt} could be annotated as a {\bf Nonunique} reference. 
...
While we only express {\bf Hearer\_Old} through the attribute value in the {\bf Anaphora} category,\nss{has attribute been defined yet?} 
in the {\bf Nonanaphora}, there are specific labels corresponding to this distinction, 
e.g.~{\bf Unique\_Hearer\_Old} and {\bf Unique\_Hearer\_New}. 
For further details on the scheme, see \citet{bhatia14} and \cref{fig:hierarchy}.
...
For instance, with the \uline{A}naphoric attribute, a value of $+$ applies to labels that can never mark NPs new to the discourse,
...
\begin{table*}\small\centering
   \begin{tabular}{lrccc}
      \bf{Leaf label} & No. of Labels & \bf{Prec.} & \bf{Recall} & \bf{F1} \\
      \midrule
Nonunique\_predicative\_identity & 10 & --- & 0.0 & --- \\
Pleonastic & 44 & 100 & 77.8 & 87.5 \\
Nonunique\_generic\_nonspec & 173 & 8.7 & 2.5 & 12.9 \\
Other\_Nonreferential & 134 & 38.5 & 35.7 & 37.0 \\
Nonunique\_Larger\_situation & 97 & 29.4 & 25.0 & 27.0 \\
Bridging\_OtherContext & 96 & 33.3 & 6.3 & 10.5 \\
Same\_head & 452 & 41.3 & 41.3 & 41.3 \\
Unique\_Hearer\_new & 26 & --- & 0.0 & --- \\
Quantified & 213 & 57.1 & 57.1 & 57.1 \\
Different\_head & 271 & 31.7 & 32.8 & 32.2 \\
Bridging\_nominal & 33 & 33.3 & 10.0 & 15.4 \\
Measure\_Nonreferential & 98 & 87.5 & 25.9 & 40.0 \\
Part\_of\_noncompositionalMWE & 88 & 20.0 & 16.7 & 18.2 \\
Bridging\_restrictiveModifier & 552 & 57.8 & 83.9 & 68.4 \\
Nonunique\_Hearer\_new\_spec & 190 & 35.8 & 46.3 & 40.4 \\
Predicative\_Nonidentity & 57 & 0.0 & 0.0 & --- \\
Uniq\_Larger\_situation & 97 & 52.3 & 57.6 & 54.8 \\
Generic\_individualLevel & 113 & 14.3 & 11.1 & 12.5 \\
Bridging\_event & 9 & --- & 0.0 & --- \\
Nonunique\_Physical\_copresence & 36 & 0.0 & 0.0 & --- \\
   \end{tabular}
