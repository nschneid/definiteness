...
\begin{figure}\small\centering  
   \begin{tabular}{p{.3\textwidth}cp{.4\textwidth}}
      ...
      This is just for \emph{the United States of America}. & Unique\_Larger\_situation & Last dependent's POS: NNP, first dependent's lemma: the\\  
      We were driving from \emph{our home in Nashville} to a little farm we have 50 miles east of Nashville --- driving ourselves. & Bridging\_restrictiveModifier & First dependent's POS: PRP\$, head's left neighbor's POS: PRP\$, governor's right neighbor's POS:PRP\$, governor's lemma: from \\
\end{tabular}
\end{figure}
