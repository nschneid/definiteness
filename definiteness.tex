...
\author{Archna Bhatia$^{\ast,\ddagger}$ \ \ \ Chu-Cheng Lin$^\ast$ \ \ \ Nathan Schneider$^\ast$ \ \ \ Yulia Tsvetkov$^\ast$ \\
 \bf Fatima Talib Al-Raisi$^\ast$ \ \ \  Laleh Roostapour$^\ast$ \ \ \ Jordan Bender$^\dagger$  \ \ \ Abhimanu Kumar$^\ast$  \\
 \bf Lori Levin$^\ast$ \ \ \ Mandy Simons$^\ast$ \ \ \  Chris Dyer$^\ast$\\[5pt]
\begin{tabular}{cc}\llap{$^\ast$}Carnegie Mellon University & \llap{$^\dagger$}University of Pittsburgh \\
Pittsburgh, PA 15213 & Pittsburgh, PA 15260\end{tabular} \\
\llap{$^\ddagger$}\texttt{archnab@cs.cmu.edu}}
...
\let\thefootnote\relax\footnote{This work is licensed under a Creative Commons Attribution 4.0 International License. Page numbers and proceedings footer are added by the organisers. License details: \url{http://creativecommons.org/licenses/by/4.0/}}%
...
\begin{table*}\small\centering
   \begin{tabular}{@{}lrrrrlrrrr@{}}
      \textbf{Leaf label} & \multicolumn{1}{c}{$N$} & \multicolumn{1}{c}{\textbf{P}} & \multicolumn{1}{c}{\textbf{R}} & \textbf{$F_1$} &
      \textbf{Leaf label} & \multicolumn{1}{c}{$N$} & \multicolumn{1}{c}{\textbf{P}} & \multicolumn{1}{c}{\textbf{R}} & \textbf{$F_1$} \\
      \midrule
Pleonastic & 44 & 100 & 78 & 88                      & Part\_of\_Noncompositional\_MWE & 88 & 20 & 17 & 18 \\
Bridging\_Restrictive\_Modifier & 552 & 58 & 84 & 68 & Bridging\_Nominal & 33 & 33 & 10 & 15 \\ 
Quantified & 213 & 57 & 57 & 57                      & Generic\_Individual\_Level & 113 & 14 & 11 & 13 \\
Unique\_Larger\_Situation & 97 & 52 & 58 & 55        & Nonunique\_Nonspec & 173 & 9 & 25 & 13 \\
Same\_Head & 452 & 41 & 41 & 41                      & Bridging\_Other\_Context & 96 & 33 & 6 & 11 \\
Measure\_Nonreferential & 98 & 88 & 26 & 40          & Bridging\_Event & 9 & --- & 0 & --- \\
Nonunique\_Hearer\_New\_Spec & 190 & 36 & 46 & 40    & Nonunique\_Physical\_Copresence & 36 & 0 & 0 & --- \\
Other\_Nonreferential & 134 & 39 & 36 & 37           & Nonunique\_Predicative\_Identity & 10 & --- & 0 & --- \\
Different\_Head & 271 & 32 & 33 & 32                 & Predicative\_Nonidentity & 57 & 0 & 0 & --- \\
Nonunique\_Larger\_Situation & 97 & 29 & 25 & 27     & Unique\_Hearer\_New & 26 & --- & 0 & --- \\
   \end{tabular}
   \caption{Number of training set instances and precision, recall, and $F_1$ percentages for leaf labels.}
   \label{tbl:leaf}
\end{table*}
...
\begin{figure}\small\centering  
   \begin{tabular}{@{}>{\raggedright}p{.35\textwidth}@{~~~}>{\raggedright\percept\bgroup}p{.35\textwidth}<{\egroup}@{~~~}p{.25\textwidth}@{}}
...
\end{tabular}
\caption{Sentences from our corpus illustrating percepts fired for gold NPs and their CFD annotations.}
