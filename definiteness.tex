...
\begin{figure}\small\centering  
   \begin{tabular}{p{.3\textwidth}cp{.3\textwidth}}
      Sentence & Annotated CFD & associated percepts as listed in Figure \ref{fig:weights} \\
      This is just for \emph{the United States of America}. & Unique\_Larger\_situation & \texttt{NNP\_last\_pos\_dependents}, \texttt{the\_first\_lemma\_dependents}\\  
      We were driving from \emph{our home in Nashville} to a little farm we have 50 miles east of Nashville --- driving ourselves. & Bridging\_restrictiveModifier & \texttt{PRP\$\_first\_pos\_dependents},\texttt{PRP\$\_pos\_head\_left},\texttt{PRP\$\_pos\_outerhead\_right}, \texttt{from\_lemma\_outerhead} \\
\end{tabular}
\end{figure}
