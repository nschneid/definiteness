...
\begin{figure}\small\centering  
   \begin{tabular}{p{.4\textwidth}p{.3\textwidth}p{.2\textwidth}}
      ...
      We were driving from \emph{our home in Nashville} to a little farm we have 50 miles east of Nashville --- driving ourselves. & \texttt{PRP\$\_first\_pos\_dependents}, \texttt{PRP\$\_pos\_head\_left}, \texttt{PRP\$\_pos\_outerhead\_right}, \texttt{from\_lemma\_outerhead} & Bridging\_restrictiveModifier \\
\end{tabular}
