...
\begin{figure}\small\centering  
   \begin{tabular}{p{.4\textwidth}p{.3\textwidth}p{.2\textwidth}}
      ...
      We were driving from \emph{our home in Nashville} to a little farm we have 50 miles east of Nashville --- driving ourselves. & First dependent's POS: PRP\$, head's left neighbor's POS: PRP\$, governor's right neighbor's POS:PRP\$, governor's lemma: from\\
\end{tabular}
