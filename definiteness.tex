...
From \cref{fig:weights}, we also know that \uline{Num. of dependents, dependent's POS: $1$,PRP\$} has a higher weight than, 
say, \uline{Num. of dependents, dependent's POS: $2$,PRP\$}. 
...
for the NP \emph{the United States of America} to be \uline{S}pecific, viz. \uline{last dependent’s POS: NNP}, and \uline{first dependent’s lemma: the}, 
...
W911NF-10-1-0533. Also we would like to thank the reviewers for their useful comments.
