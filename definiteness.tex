...
and $0$ applies to labels such as {\bf Pleonastic} (where anaphoricity is not applicable because there is no discourse referent). For details on the scheme, see \citet{bhatia14}.
...
\end{itemize}
\ab{TODO: We need to enter these numbers.}
